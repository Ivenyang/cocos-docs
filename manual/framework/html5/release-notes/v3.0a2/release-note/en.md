...
* **[Alpha2 Feature]** Support `new` operator for engine classes, constructor accept the same parameters as create functions, and permit developer to pass initilization parameters in `ctor` while extend engine classes, [document reference](http://www.cocos2d-x.org/docs/manual/framework/html5/v3.0/inheritance/en)
