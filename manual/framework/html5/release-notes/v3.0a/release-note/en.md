...
- [Downloadable API reference](http://cdn.cocos2d-x.org/Cocos2d-html5_v3.0_Alpha_API_Doc.zip)
...
* A new all-type extendable loader is added for resource loading process, [cc.loader document](http://www.cocos2d-x.org/docs/manual/framework/html5/v3.0/cc-loader/en).
* Refactor foundational data structures for better maintainability, [basic datas document](http://www.cocos2d-x.org/docs/manual/framework/html5/v3.0/basic-data/en).
