- 用户手册
	...
	- Cocos2d-html5
		...
		- 新手指引
			...
			- [屏幕适配方案](../manual/framework/html5/resolution-policy-design/zh.md)
		- 3.0版本的新功能与API改进
			- [新事件处理机制](../manual/framework/html5/v3.0/eventManager/zh.md)
			- [新属性API](../manual/framework/html5/v3.0/getter-setter-api/zh.md)
		- JSB
